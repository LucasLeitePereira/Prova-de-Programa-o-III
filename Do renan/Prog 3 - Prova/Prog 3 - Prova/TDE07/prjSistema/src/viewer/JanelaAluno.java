...
public class JanelaAluno extends JFrame {
	...
	public JanelaAluno() {
        ...
        btRemover.setBounds(170, 243, 100, 23);
    ...
    private void removerAluno() {
        ...
        if (matricula == null || matricula.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Informe a matrícula do aluno a ser removido.");
            return;
        }
        DaoAluno daoA = new DaoAluno();
        Aluno a = daoA.obterAlunoPelaMatricula(matricula);
        if (a == null) {
            JOptionPane.showMessageDialog(this, "Aluno não encontrado para a matrícula informada.");
            return;
        }

        boolean ok = daoA.remover(a);
