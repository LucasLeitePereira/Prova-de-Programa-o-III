...
public class Pessoa {
	...
	// ATRIBUTOS
	//
	public String cpf;   // tipo do atributo cpf: Ponteiro para (um objeto) String
	public String nome;  // tipo do atributo nome: Ponteiro para (um objeto) String
	public int    idade; // tipo do atributo idade: int (tipo primitivo)
